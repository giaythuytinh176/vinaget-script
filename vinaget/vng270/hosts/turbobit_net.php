...
class dl_turbobit_net extends Download {
	public function CheckAcc($cookie){
		...
		if (stristr($data, '<u>Turbo Access</u> to')) return array(true, "Until ".$this->lib->cut_str($data, 'turbo.png\'> <u>Turbo Access</u> to','</div>'));
		elseif(stristr($data, '<u>Turbo Access</u> denied')) return array(false, "accfree");
	...
	public function Leech($url) {
		...
		elseif (stristr($data, 'You have reached the <a href=\'/user/messages\'>daily</a> limit of premium downloads')) $this->error("LimitAcc");
		return false;
	}
