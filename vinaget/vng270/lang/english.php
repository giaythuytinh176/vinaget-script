...
'yourip'		=> 'Your IP: %s.',
'yourjob'		=> 'Your jobs: %s (max: %s).',
'youused'		=> 'You used %s (max: %s).',
'sizelimit'		=> 'File size limit: %s.',
'totjob'		=> 'Total jobs: %s (max: %s).',
'serverload'	=> 'Server load: %s (max allowed: %s).',
'uonline'		=> 'Users online: %s',
'ago'			=> 'ago',
'days'			=> 'days',
'hours'			=> 'hours',
'mins'			=> 'mins',
