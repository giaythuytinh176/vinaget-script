...
class dl_alldebrid_com extends Download {
	...
	public function Login($user, $pass){
		$data = $this->lib->curl("http://www.alldebrid.com/register/?action=login&returnpage=&login_login=".urlencode($user)."&login_password=".urlencode($pass),"","login_login=".urlencode($user)."&login_password=".urlencode($pass));
    ...
    public function Leech($url) {	
		...
		$data = $this->lib->curl("https://www.alldebrid.com/service.php?link={$url}&json=true&pw={$pass}", $this->lib->cookie, "",0);
